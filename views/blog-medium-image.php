...
<!-- Mirrored from themeelite.com/demos/e-learn/image+text-rotator/blog-medium-image.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Jan 2023 18:03:10 GMT -->
<head>
  ...
  <header> 
    ...
    <div class="menu">
      <div class="navbar-wrapper">
        <div class="container"> 
          <!--Logo -->
          <div class="logo"><a href="index-2.html"><span class="img-circle">e</span>learn</a> </div>
          <!--Logo -->
                ...
                <nav class="navArea">
                  ...
                  <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav" id="navigation">
                      ...
                      <li class="menuItem"><a href="index.html#features">features</a></li>
                      <li class="menuItem"><a href="index.html#courses">courses</a></li>
                      <li class="menuItem"><a href="index.html#teachers">teachers</a></li>
                      <li class="menuItem"><a href="index.html#pricing">pricing</a></li>
                      <li class="menuItem"><a href="index.html#testimonial">Testimonial</a></li>
        ...
        <div class="row">
          <div class="col-sm-8 col-md-8 col-lg-8">
            <div class="blog_large">
              <article class="post">
                <div class="post_date"> <span class="day">28<a href="#" class="month">Nov</a></span> <span class="icon"><i class="fa fa-file-image-o"></i> </span> </div>
                <div class="post_content medium">
                  <figure class="post_img"> 
                    ...
                    <div id="slider" class="swipe">
                      <ul class="swipe-wrap">
                        <li><img src="images/blog/img1.jpg" alt="blog post"></li>
                        <li><img src="images/blog/img2.jpg" alt="blog post"></li>
                        <li><img src="images/blog/img3.jpg" alt="blog post"></li>
                      </ul>
                  ...
                  <div class="post_meta">
                    <h2> <a href="blog-single.html">perferendis doloribus asperiores ut labore</a> </h2>
                    <div class="metaInfo"> <span>By <a href="#" class="admin">Admin</a> </span> <span><a href="#">Webdesign, Media, Logo</a> </span> <span><a href="#" class="admin">5</a> Comments</span> </div>
                    ...
                    <a href="blog-single.html" class="btn btn-small btn-default readmore">Read More</a> </div>
                </div>
              </article>
              <!-- Post Image Slider End--> 
              <!-- Post Static Image Start-->
              <article class="post">
                <div class="post_date"> <span class="day">28<a href="#" class="month">Nov</a></span> <span class="icon"><i class="fa fa-files-o"></i> </span> </div>
                <div class="post_content medium">
                  <figure class="post_img"> <img src="images/blog/img1.jpg" width="700" height="370" alt=" "> </figure>
                  <div class="post_meta">
                    <h2> <a href="blog-single.html">perferendis doloribus asperiores ut labore</a> </h2>
                    <div class="metaInfo"> <span>By <a href="#" class="admin">Admin</a> </span> <span><a href="#">Webdesign, Media, Logo</a> </span> <span><a href="#" class="admin">5</a> Comments</span> </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adip, sed do eiusmod tempor incididunt  ut aut reiciendise voluptat maiores alias consequaturs aut perferendis doloribus asperiores ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
              ...
              <article class="post">
                ...
                <div class="post_content medium">
                  <figure class="post_video">
                    <div class="video">
                      <iframe src="http://player.vimeo.com/video/121572408?title=0&amp;byline=0&amp;portrait=0"></iframe>
                    </div>
                  </figure>
                  <div class="post_meta">
                    <h2> <a href="blog-single.html">perferendis doloribus asperiores ut labore</a> </h2>
              ...
              <article class="post">
                ...
                <div class="post_content medium">
                  <figure class="post_video">
                    <div class="video">
                      <iframe src="https://www.youtube.com/embed/rU1vi9h3YUU" frameborder="0" allowfullscreen></iframe>
                    </div>
                  </figure>
                  <div class="post_meta">
                    <h2> <a href="blog-single.html">perferendis doloribus asperiores ut labore</a> </h2>
            ...
            <div class="sidebar_widget">
              ...
              <div class="sw_archives">
                ...
                <ul class="archives_list">
                  <li><a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididuntur.</a></li>
                  <li><a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididuntur.</a></li>
                  <li><a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididuntur.</a></li>
                </ul>
              </div>
              <div class="sw_archives">
                ...
                <ul class="archives_list">
                  <li>Make sure you are following <a href="#"><u>@EnvatoMarket</u></a> for all your ThemeForest needs!</li>
                  <li>Make sure you are following <a href="#"><u>@EnvatoMarket</u></a> for all your ThemeForest needs!</li>
                  <li>Make sure you are following <a href="#"><u>@EnvatoMarket</u></a> for all your ThemeForest needs!</li>
                </ul>
              </div>
...
<!-- Mirrored from themeelite.com/demos/e-learn/image+text-rotator/blog-medium-image.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Jan 2023 18:04:04 GMT -->
</html>